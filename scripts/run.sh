...
python /home/nitish/SkipPatch/scripts/run.py -SPBinary "/home/nitish/SkipPatch/src/main" -SABinary "/home/nitish/SkipPatch/dyn_sa/src/test" -o "/mnt/scratch2/nirm/results/" -l "/mnt/scratch2/nirm/results/" -rc '-g /mnt/scratch2/nirm/data/ecoli.fa -e /home/komal/data/update_number/ecoli_0.01 -n 464 -lh /mnt/scratch2/nirm/hash -sh /mnt/scratch2/nirm/hash'
